...
export declare class BalancesApi extends BaseAPI {
     ...
     */
    listBalances(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListBalancesResponse>>;
    /**
     * Retrieves the balance of funds that are available for use.
     * @summary List all balances
     * @param {*} [options] Override http request option.
     ...
     * @memberof BalancesApi
     */
    listBusinessBalances(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListBusinessBalancesResponse>>;
}
