...
export declare class CardsApi extends BaseAPI {
     ...
     * @memberof CardsApi
     */
    createCard(cardCreationRequest?: CardCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateCardResponse>>;
    /**
     *
     * @summary Get a card
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CardsApi
     */
    getCard(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetCardResponse>>;
    /**
     *
     * @summary List all cards
     * @param {string} [pageBefore] A collection ID value used for pagination.  It marks the exclusive end of a page. When provided, the collection resource will return the next &#x60;n&#x60; items before the id, with &#x60;n&#x60; being specified by &#x60;pageSize&#x60;.  The items will be returned in the natural order of the collection.  The resource will return the first page if neither &#x60;pageAfter&#x60; nor &#x60;pageBefore&#x60; are specified.  SHOULD NOT be used in conjuction with pageAfter.
     ...
     * @memberof CardsApi
     */
    listCards(pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListCardsResponse>>;
    /**
     *
     * @summary Update a card
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CardsApi
     */
    updateCard(id: string, cardUpdate?: CardUpdate, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<UpdateCardResponse>>;
}
