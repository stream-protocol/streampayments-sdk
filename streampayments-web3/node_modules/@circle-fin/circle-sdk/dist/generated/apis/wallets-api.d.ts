...
export declare class WalletsApi extends BaseAPI {
     ...
     * @memberof WalletsApi
     */
    createWallet(walletCreationRequest?: WalletCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateWalletResponse>>;
    /**
     * Generates a new blockchain address for a wallet for a given currency/chain pair. Circle may reuse addresses on blockchains that support reuse. For example, if you\'re requesting two addresses for depositing USD and ETH, both on Ethereum, you may see the same Ethereum address returned. Depositing cryptocurrency to a generated address will credit the associated wallet with the value of the deposit.
     * @summary Create a blockchain address
     * @param {string} walletId Identifier for the wallet.
     ...
     * @memberof WalletsApi
     */
    generateAddress(walletId: string, generateAddressRequest?: GenerateAddressRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GenerateAddressResponse>>;
    /**
     *
     * @summary Get a wallet
     * @param {string} walletId Identifier for the wallet.
     ...
     * @memberof WalletsApi
     */
    getWallet(walletId: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetWalletResponse>>;
    /**
     * Retrieves a list of addresses associated with a wallet.
     * @summary List all addresses
     * @param {string} walletId Identifier for the wallet.
     ...
     * @memberof WalletsApi
     */
    listAddresses(walletId: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListAddressesResponse>>;
    /**
     * Retrieves a list of a user\'s wallets.
     * @summary List all wallets
     * @param {string} [from] Queries items created since the specified date-time (inclusive).
     ...
     * @memberof WalletsApi
     */
    listWallets(from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListWalletsResponse>>;
}
