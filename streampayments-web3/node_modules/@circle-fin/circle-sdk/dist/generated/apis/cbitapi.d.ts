...
export declare class CBITApi extends BaseAPI {
     ...
     * @memberof CBITApi
     */
    createBusinessCbitAccount(cbitFiatAccountCreationRequest?: CbitFiatAccountCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateBusinessCbitAccountResponse>>;
    /**
     *
     * @summary Get a CBIT bank account
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CBITApi
     */
    getBusinessCbitAccount(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetBusinessCbitAccountResponse>>;
    /**
     * Get the CBIT transfer instructions into the Circle bank account given your bank account id.
     * @summary Get CBIT instructions
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CBITApi
     */
    getBusinessCbitAccountInstructions(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListBusinessCbitAccountInstructionsResponse>>;
    /**
     *
     * @summary List all CBIT bank accounts.
     * @param {*} [options] Override http request option.
     ...
     * @memberof CBITApi
     */
    listBusinessCbitAccounts(options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListBusinessCbitAccountsResponse>>;
}
