...
export declare class CryptoAddressBookApi extends BaseAPI {
     ...
     */
    createAddressBookRecipient(addressBookRecipientRequest?: AddressBookRecipientRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateAddressBookRecipientResponse>>;
    /**
     *
     * @summary Delete a recipient
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CryptoAddressBookApi
     */
    deleteAddressBookRecipient(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     *
     * @summary Get a recipient
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CryptoAddressBookApi
     */
    getAddressBookRecipient(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetAddressBookRecipientResponse>>;
    /**
     *
     * @summary List all recipients
     * @param {string} [address] Filters results to fetch only address book recipients with the provided address.
     ...
     * @memberof CryptoAddressBookApi
     */
    listAddressBookRecipients(address?: string, chain?: string, email?: string, status?: "pending" | "inactive" | "active" | "denied", from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListAddressBookRecipientsResponse>>;
    /**
     *
     * @summary Modify a recipient
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof CryptoAddressBookApi
     */
    modifyAddressBookRecipient(id: string, addressBookRecipientModifyRequest?: AddressBookRecipientModifyRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ModifyAddressBookRecipientResponse>>;
}
