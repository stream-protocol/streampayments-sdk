...
export declare class ChargebacksApi extends BaseAPI {
     ...
     */
    createMockChargeback(mockChargebackCreationRequest?: MockChargebackCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateMockChargebackResponse>>;
    /**
     *
     * @summary Get a chargeback
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
     ...
     * @memberof ChargebacksApi
     */
    getChargeback(id: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GetChargebackResponse>>;
    /**
     * Retrieve list of chargebacks. Results will be sorted by create date descending: more recent chargebacks will be at the beginning of the list.
     * @summary List all chargebacks
     * @param {string} [paymentId] The payment ID associated with the chargeback.
     ...
     * @memberof ChargebacksApi
     */
    listChargebacks(paymentId?: string, from?: string, to?: string, pageBefore?: string, pageAfter?: string, pageSize?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListChargebacksResponse>>;
}
