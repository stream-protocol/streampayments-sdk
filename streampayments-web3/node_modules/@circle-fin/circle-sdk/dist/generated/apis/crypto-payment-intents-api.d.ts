...
export declare class CryptoPaymentIntentsApi extends BaseAPI {
     ...
     */
    createPaymentIntent(createPaymentIntentRequest?: CreatePaymentIntentRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreatePaymentIntentResponse>>;
    /**
     *
     * @summary Expire a payment intent
     * @param {string} id Universally unique identifier (UUID v4) of a resource.
