...
export declare class PullCryptoPaymentsApi extends BaseAPI {
     ...
     */
    createCryptoPayment(cryptoPaymentCreationRequest?: CryptoPaymentCreationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateCryptoPaymentResponse>>;
    /**
     *
     * @summary Get a typed message for signing
     * @param {string} endUserAddress User wallet address
     ...
     * @memberof PullCryptoPaymentsApi
     */
    presign(endUserAddress: string, paymentIntentId: string, amount?: string, currency?: "USD", options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CreateCryptoPaymentResponse1>>;
}
